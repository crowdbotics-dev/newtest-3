"""
Django settings for newtest_3 project.
...
WSGI_APPLICATION = 'newtest_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "newtest_3 API",
    "DESCRIPTION": "API documentation for newtest_3 App",
    "VERSION": "v1",
}
